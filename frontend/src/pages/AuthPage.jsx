    ...
    <div className="page">
      ...
      <div className="frame">
        <aside className="brand-panel">
          ...
          <h1>{heroHeadline}</h1>
          <p className="lede">
            Authenticate into a refreshed LINKEDIN experience with a crisp visual design
            and fast, modern security defaults.
          </p>
          ...
          {view === 'auth' ? (
            <>
              ...
              <div className="panel-body">
                ...
                <p className="subtext">
                  Use your work email to sync with recruiters, hiring teams, and the people
                  you already know.
                </p>
                ...
                <div className={`status ${status.type !== 'idle' ? status.type : ''}`}>
            ...
            <div className="panel-body profile">
              ...
              <p className="subtext">
                Tell LINKEDIN how you work, learn, and collaborate. Save to finish
                onboarding.
              </p>
              ...
              <form className="form" onSubmit={handleProfileSubmit}>
                ...
                <div className={`status ${profileStatus.type !== 'idle' ? profileStatus.type : ''}`}>
